...
public class Calculator {
     ...
     * Alexander Büerklen: Die if-Schleife prüft, ob die Variable "result" einen "NaN" als Ausgabe gibt
     * oder nicht. Wenn es einen "NaN" ausgibt wird eine eigenständige "ArithmeticException" geworfen
    ...
    public void pressUnaryOperationKey(String operation) {
        ...
        try {
            if (Double.isNaN(result)) {
                throw new ArithmeticException(screen = "Error");
            }
